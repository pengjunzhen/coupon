...
public class CouponCustomerServiceImpl implements CouponCustomerService {
    ...
    public CouponCustomerServiceImpl(CouponDao couponDao, CouponTemplateService templateService, CouponCalculationService calculationService) {
    ...
    public ShoppingCart placeOrder(ShoppingCart shoppingCart) {
        ...
        // order清算
        ShoppingCart checkoutInfo = calculationService.calculateOrderPrice(shoppingCart);
